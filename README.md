# my-springboot-helloworld [![Build Status](https://travis-ci.org/bongani-m/my-springboot-helloworld.svg?branch=master)](https://travis-ci.org/bongani-m/my-springboot-helloworld)
